<%-- 
    Document   : verCanal
    Created on : 13-dic-2018, 19:50:13
    Author     : aitor
--%>
                ...
                <div class="col-lg-9">
                    <div class="row">
                        <div class="col-lg-12 my-4">
                            <h2>Canal de ${sessionScope.usuarioVerCanal.nombreCanal}</h2>
                        </div>
                        <div class="col-lg-12">
                            <div class="list-group" style="padding: 15px;">
                                <a href="../Controlador?direccion=verPeliculasCanal" class="list-group-item">Peliculas</a>
                                <a href="../Controlador?direccion=verSeriesCanal" class="list-group-item">Series</a>
                                <a href="../Controlador?direccion=verVideosCanal" class="list-group-item">Videos</a>
                            </div>
                        </div>
                    </div>
                    <!-- /.row -->
