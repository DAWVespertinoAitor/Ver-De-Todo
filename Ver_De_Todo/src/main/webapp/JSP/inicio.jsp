            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="./JSP/videos.jsp">Videos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="./JSP/series.jsp">Series</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="./JSP/peliculas.jsp">Peliculas</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="./JSP/cuenta.jsp">Cuenta</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="./JSP/subirArchivo.jsp">Subir archivo</a>
                        </li>
                    </ul>
                </div>
            </div>
