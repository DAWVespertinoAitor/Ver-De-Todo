<%-- 
    Document   : temporadasSeriesCanal
    Created on : 13-dic-2018, 23:38:06
    Author     : aitor
--%>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 style="padding: 15px;">${sessionScope.serieObtenidaCanal.get(0).tituloSerie}</h3>
                            <img src="http://127.0.0.1:8887/${sessionScope.serieObtenidaCanal.get(0).nombrePortada}" style="float: left; padding: 0 15px; max-height: 321.19px; min-height: 321.19px;"/>
                            <h5>Descripcion </h5>
                            <p>${sessionScope.serieObtenidaCanal.get(0).descripcion}</p>
                        </div>
                        <div class="col-lg-12">
                            <div class="list-group" style="padding: 15px;">
                                <c:forEach var="temporadas" items="${sessionScope.serieObtenidaCanal}">
                                    <a href="../Controlador?direccion=capitulosTemporadaCanal&temporadaNumeroCanal=${temporadas.temporada}" class="list-group-item">Temporada ${temporadas.temporada}</a>
                                </c:forEach>
                            </div>
                        </div>
                    </div>
