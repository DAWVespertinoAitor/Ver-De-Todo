<%-- 
    ...
    Created on : 12-dic-2018, 23:48:06
    Author     : aitor
--%>
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="row my-4" id="contenido">
                        <c:if test="${sessionScope.misPeliculas.size() == 0 || sessionScope.misPeliculas == null}">
                            <div class="col-lg-12 mb-4">
                                <h2>Aun no has subido ninguna pelicula a tu canal</h2>
                            </div>
                        </c:if>
                        <c:forEach var="pelicula" items="${sessionScope.misPeliculas}">
