<%-- 
    Document   : capitulosTemporada
    Created on : 13-dic-2018, 21:53:59
    Author     : aitor
--%>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 style="padding: 15px;">Temporada ${sessionScope.capitulosTemporada.get(0).temporada}</h3>
                        ...
                        <div class="col-lg-12">
                            <div class="list-group" style="padding: 15px;">
                                <c:forEach var="capitulos" items="${sessionScope.capitulosTemporada}">
