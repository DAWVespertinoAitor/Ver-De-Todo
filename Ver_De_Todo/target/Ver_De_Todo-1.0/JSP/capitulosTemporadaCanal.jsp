<%-- 
    Document   : capitulosTemporadaCanal
    Created on : 13-dic-2018, 23:45:36
    Author     : aitor
--%>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 style="padding: 15px;">Temporada ${sessionScope.capitulosTemporadaCanal.get(0).temporada}</h3>
                        ...
                        <div class="col-lg-12">
                            <div class="list-group" style="padding: 15px;">
                                <c:forEach var="capitulos" items="${sessionScope.capitulosTemporadaCanal}">
                                    <a href="../Controlador?direccion=verSerie&idCapitulo=${capitulos.idSerie}" class="list-group-item">Capitulo ${capitulos.numCapitulo}</a>
                                </c:forEach>
                            </div>
                        </div>
                    </div>
