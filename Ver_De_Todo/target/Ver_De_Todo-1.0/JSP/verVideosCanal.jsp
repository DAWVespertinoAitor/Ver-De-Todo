<%-- 
    Document   : verVideosCanal
    Created on : 13-dic-2018, 23:20:49
    Author     : aitor
--%>
    ...
    <body class="scrollbar scrollbar-primary">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <!-- /.col-lg-3 -->
                <div class="col-lg-9">
                    <c:if test="${sessionScope.videosCanal.size() == 0}">
                        <div class="col-lg-12 mb-4">
                            <h2>${sessionScope.usuarioVerCanal.nombreCanal} aun no ha subido ningún video.</h2>
                        </div>
                    </c:if>
                    <c:if test="${sessionScope.videosCanal.size() != 0}">
                        <div class="col-lg-12 mb-4">
                            <h2>Videos del canal ${sessionScope.usuarioVerCanal.nombreCanal}</h2>
                        </div>
                    </c:if>
                    <c:forEach var="miVideo" items="${sessionScope.videosCanal}">
