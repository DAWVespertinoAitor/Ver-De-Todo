<%-- 
    Document   : verVideo
    Created on : 13-dic-2018, 23:21:24
    Author     : aitor
--%>
                ...
                <div class="col-lg-9">
                    <div class="row my-4">
                        <div class="col-lg-12 my-4 container2" style=" padding-right: 0;">
                            <h3>${sessionScope.verVideo.titulo}</h3>
                            <c:if test=" ${sessionScope.verVideo.descripcion != '                                                    '}">
                                <b>Descripcion</b>
                                <p> ${sessionScope.verVideo.descripcion} </p>
                            </c:if>
                            <c:if test="${sessionScope.verVideo.descripcion == '                                                    '}">
                                <p> Este video no contiene descripción </p>
                            </c:if>
                        </div>
