<%-- 
    ...
    Created on : 12-dic-2018, 20:36:53
    Author     : aitor
--%>
...
<html>
    <head>
        ...
        <title>${sessionScope.verPelicula.titulo} | Ver-de Todo</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="../Controlador?direccion=peliculas">Peliculas</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="col-lg-9">
                    <div class="row my-4">
                        <div class="col-lg-12 my-4 container2" style=" padding-right: 0;">
                            <h3 style="padding: 15px;">${sessionScope.verPelicula.titulo}</h3>
                            <img src="http://127.0.0.1:8887/${sessionScope.verPelicula.nombrePortada}" style="float: left; padding: 0 15px; max-height: 321.19px; min-height: 321.19px;"/>
                            <h5>Sinopsis </h5>
                            <p>${sessionScope.verPelicula.sinopsis}</p>
                            <p><b>Genero:</b> ${sessionScope.verPelicula.genero}</p>
                            <p><b>Idioma:</b> ${sessionScope.verPelicula.pais}</p>
                            <c:if test="${sessionScope.verPelicula.subtitulos != ''}">
                        ...
                        <div class="col-lg-12 my-4 container2" style=" margin-left: 15px;">
                            <video controls src="http://127.0.0.1:8887/${sessionScope.verPelicula.nombreArchivo}" width="100%" style="max-height: 480px;"></video>
                        </div>
